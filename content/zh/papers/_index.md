...
1. **[软件学报]** "面向节点分类的多层异质图神经网络"       
   于朋健#, 李享#, 齐建鹏, **于彦伟***, 董军宇       
   *软件学报*, (**CCF A**中文期刊)   
   [📄 PDF](#) | [💻 Code](#) | [📑 Cite](#)

1. **[ICDE 2025]** "UMGAD: Unsupervised Multiplex Graph Anomaly Detection"  
...
1. **[AAAI 2025]** "Correlation Attention Masked Temporal Transformer for User Identity Linkage using Heterogeneous Mobility Data"  
...
1. **[AAAI 2025]** "Scalable Trajectory-User Linking with Dual-Stream Representation Networks"  
   Hao Zhang#, Wei Chen#, Xingyu Zhao#, Jianpeng Qi, Guiyuan Jiang, ****Yanwei Yu*****  
   *Proceedings of Thirty-Ninth AAAI Conference on Artificial Intelligence*  
   (**CCF A**, acceptance rate=3032/12957=23.4%, Oral)  
   [📄 PDF](#) | [💻 Code](#) | [📑 Cite](#)

1. **[AAAI 2025]** "Spatiotemporal-aware Trend-Seasonality Decomposition Network for Traffic Flow Forecasting"  
   Lingxiao Cao#, Bin Wang, Guiyuan Jiang, **Yanwei Yu***, Junyu Dong  
   *Proceedings of Thirty-Ninth AAAI Conference on Artificial Intelligence*  
   (**CCF A**, acceptance rate=3032/12957=23.4%, Oral)  
   [📄 PDF](#) | [💻 Code](#) | [📑 Cite](#)

1. **[AAAI 2025]** "Lightweight yet Fine-grained: A Graph Capsule Convolutional Network with Subspace Alignment for Shared-account Sequential Recommendation"  
   Jinyu Zhang, Zhongying Zhao, Chao Li, **Yanwei Yu**  
   *Proceedings of Thirty-Ninth AAAI Conference on Artificial Intelligence*  
   (**CCF A**, acceptance rate=3032/12957=23.4%, Oral)  
   [📄 PDF](#) | [💻 Code](#) | [📑 Cite](#)

1. **[ICDE 2025]** "Self-supervised Trajectory Representation Learning with Multi-scale Spatio-temporal Feature Exploration"  
...
1. **[KDD 2024]** "Dataset Condensation for Time Series Classification via Dual Domain Matching"  
...
1. **[ECML/PKDD 2024]** "Hierarchical Graph Contrastive Learning for Review-Enhanced Recommendation"  
...
1. **[CIKM 2024]** "MoTTo: Scalable Motif Counting with Time-aware Topology Constraint for Large-scale Temporal Graphs"  
...
1. **[CIKM 2024]** "Hypergraph Hash Learning for Efficient Trajectory Similarity Computation"  
...
1. **[IJCAI 2024]** "Multi-Relational Graph Attention Network for Social Relationship Inference from Human Mobility Data"  
...
1. **[TIST 2024]** "MHGCN+: Multiplex Heterogeneous Graph Convolutional Network"  
...
1. **[TOIS 2024]** "MCN4Rec: Multi-Level Collaborative Neural Network for Next Location Recommendation"  
...
1. **[TKDD 2024]** "Trajectory-User Linking via Hierarchical Spatio-Temporal Attention Networks"  
...
1. **[ISKE 2023]** "DeepNWP4Wind: A Wind Forcasting Correction Solution in View of Multi-Criteria Evaluation"  
...
1. **[ISKE 2023]** "ST-MoE: Spatio-temporal Mixture of Experts for Multivariate Time Series Forecasting"  
   Hanwen Liu, Yibing Zhang, Ximeng Wang, Bin Wang, **Yanwei Yu**  
   *Proceddings of the 18th International Conference on Intelligent System and Knowledge Engineering*   
   (Best Student Paper Reward)    
   [📄 PDF](#) | [💻 Code](#) | [📑 Cite](#)

1. **[CIKM 2023]** "Cross-city Few-Shot Traffic Forecasting via Traffic Pattern Bank"  
...
1. **[KDD 2023]** "Multiplex Heterogeneous Graph Neural Network with Behavior Pattern Modeling"  
...
1. **[KBS 2023]** "Robust Anomaly Detection for Multivariate Time Series through Temporal GCNs and Attention-based VAE"  
...
1. **[FGCS 2023]** "Self-Supervised Contrastive Representation Learning for Large-Scale Trajectories"  
...
1. **[TBD 2021]** "Citywide Traffic Volume Inference with Surveillance Camera Records"   
...
1. **[ICDM 2021]** "Temporal Multi-view Graph Convolutional Networks for Citywide Traffic Volume Inference"  
   Shaojie Dai#, Jinshuai Wang#, Chao Huang, **Yanwei Yu***, Junyu Dong  
...
1. **[WWW 2021]** "Motif-Preserving Dynamic Attributed Network Embedding"  
...
1. **[DASFAA 2021]** "Personalized POI Recommendation: Spatio-Temporal Representation Learning with Social Ties"  
...
1. **[CIKM 2020]** "Fast Attributed Multiplex Heterogeneous Network Embedding"  
...
1. **[CIKM 2020]** "Dynamic Representation Learning for Large-Scale Attributed Networks"  
...
1. **[PRCV 2020]** "Student Performance Prediction based on Multi-View Network Embedding"  
...
1. **[KBS 2020]** "Scalable KDE-based Top-n Local Outlier Detection over Large-Scale Data Streams"  
...
1. **[TCDS 2020]** "Speech Emotion Recognition Based on Robust Discriminative Sparse Regression"  
   Peng Song, Wenming Zheng, **Yanwei Yu**, Shifeng Ou  
   *IEEE Transactions on Cognitive and Developmental Systems*  
   (In press)    
   [📄 PDF](https://ieeexplore.ieee.org/abstract/document/9080065) | [💻 Code](#) | [📑 Cite](#)    

1. **[KBS 2020]** "Find You If You Drive: Inferring Home Locations for Vehicles with Surveillance Camera Data"  
...
1. **[KBS 2020]** "Layer-constrained Variational Autoencoding Kernel Density Estimation Model for Anomaly Detection"  
...
1. **[DASFAA 2020]** "Anomaly Detection in High-dimensional Data Based on Autoregressive Flow"  
...
1. **[IS 2020]** "Shape-optimizing mesh warping method for stereoscopic panorama stitching"  
...
1. **[IEEE Access 2020]** "Ordering-Based Kalman Filter Selective Ensemble for Classification"  
